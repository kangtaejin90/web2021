...
<script>
  ...
  var menuDep = $(".loc1D").html();
  console.log("회사소개" + menuDep);
  if(menuDep == "회사소개"){$("#page_title .title .txt").text("저희 홈페이지를 찾아주셔서 감사합니다.");}
  else if(menuDep == "커뮤니티"){$("#page_title .title .txt").text("커뮤니티 공간입니다.");}
  else{$("#page_title .title .txt").text("아주 나이스");};
  };
</script>
...
<div id="wrapper">
    ...
    <div id="container" <?if(defined("_INDEX_")){echo "style=\"width:100%\"";}?>  >
        <?php if (!defined("_INDEX_")) { ?>
          <!-- 메인페이지가 아니면 = 서브페이지 -->
          <h2 id="container_title"><span title="
